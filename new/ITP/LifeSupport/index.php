...
<p>So for my Hello, Computer final project, I created a self-care assistant with DialogFlow, Google's conversational interface technology. Named Life Support, it's a relatively sprawling/unfocused endeavor that attempts to intervene generally on common/modern emotional discomforts. While I plan to build this out even more as part of my thesis, Life Support presently consists of the following features:</p>
<ol>
